...
public readonly struct SmallXXHash
{
	...
	public static SmallXXHash Select(SmallXXHash a, SmallXXHash b, bool c) => math.select(a.accumulator, b.accumulator, c);
	...
	public float GetBitsAsFloats01(int count, int shift) => GetBits(count, shift) * (1f / ((1 << count) - 1));
}
