...
public static partial class Noise
{
    ...
    {
        public LatticeSpan4 GetLatticeSpan(float4 coordinates, int frequency);
        ...
        where L : struct, ILattice
    {
        ...
        {
            LatticeSpan4 x =  default(L).GetLatticeSpan(positions.c0, frequency);
            var g = default(G);
        ...
        where L : struct, ILattice
    {
        public float4 GetNoise4(float4x3 positions, SmallXXHash4 hash, int frequency)
        {
            ...
            LatticeSpan4
                ...
                y =  l.GetLatticeSpan(positions.c1, frequency),
